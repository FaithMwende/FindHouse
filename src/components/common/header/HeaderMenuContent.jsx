...
const HeaderMenuContent = ({ float = "" }) => {
  ...
  return (
    ...
    >
      ...
      <li className="last">
        <Link href="/listing-map-v1">
          <a
            className={route.pathname === "/listing-map-v1" ? "ui-active" : undefined}
          >
            Listing
          </a>
        </Link>
      ...
      <li className="last">
        <Link href="/agent-v2">
          <a
            className={route.pathname === "/agent-v2" ? "ui-active" : undefined}
          >
            Agents
          </a>
        </Link>
      ...
      <li className={`list-inline-item add_listing ${float}`}>
        <Link href="/my-dashboard">
          <a>
            <span className="flaticon-plus"></span>
            <span className="dn-lg"> User Admin</span>
          </a>
        </Link>
      </li>
      {/* End .dropitem */}
